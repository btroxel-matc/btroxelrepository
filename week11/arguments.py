...
parser.add_argument('-i', '--integer', metavar='[an integer]', dest='varinteger', required=True, type=int, help='<integer> Enter a simple Integer.')
...
parser.add_argument('-l', metavar='[strings] [[strings] ...]', dest='varlist', type=str, nargs='+', help='Enter a list of strings (space delimited)')
